...
{
    public class WeiXinLoginUserManager
    {
        /// 作者：Malei
        /// 时间：2014.04.25
        /// 描述：当前登录用户
        ...
        public static WeiXinUser CurrLoginUser
        {
            get
            {
                return HttpContext.Current.Session[Global.WeiXinLoginUserKey] as WeiXinUser;
            }
        }
        ...
        {
            get { return (HttpContext.Current.Session[Global.WeiXinLoginUserKey] != null); }
        }
        ...
        {
            //设置当前登录用户
            HttpContext.Current.Session[Global.WeiXinLoginUserKey] = user;
        ...
        {
            var loginUsers = (HttpContext.Current.Application[Global.WeiXinLoginUserKey] as NameValueCollection) ?? new NameValueCollection();

            loginUsers.Set(userId, sessionId);
            HttpContext.Current.Application[Global.WeiXinLoginUserKey] = loginUsers;
        }
        ...
        {
            var loginUsers = HttpContext.Current.Application[Global.WeiXinLoginUserKey] as NameValueCollection;
            if (loginUsers != null)
            {
